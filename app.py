...
#    - Creación de una aplicación web simple en Python utilizando el
#      framework Flask.
...
#    - Desarrollo de pruebas unitarias con Pytest para asegurar la calidad.
#
# 2. Dockerización (Fase 2):
#    - Creación de un Dockerfile para empaquetar la aplicación y sus
#      dependencias.
...
#    - Creación automatizada de un servidor EC2 (t2.micro) y grupos de
#      seguridad.
#    - Configuración de reglas de firewall para permitir tráfico HTTP, SSH y
#      de monitoreo.
#    - Implementación de un script de inicio (user_data) para la instalación
#      automática de Docker.
#
...
#    - Ejecución automática de análisis de código estático (Linting con
#      Flake8).
#    - Ejecución automática de pruebas unitarias (Pytest) ante cada cambio.
#
# 5. Despliegue Continuo - CD (Fase 5):
#    - Extensión del pipeline para la construcción automática de imágenes.
...
#    - Instrumentación de la aplicación para exponer métricas personalizadas.
#    - Visualización de métricas en tiempo real mediante dashboards.
# -----------------------------------------------------------------------------
